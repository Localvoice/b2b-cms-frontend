...
export const getters = {
  getActivePage: createGetter((state) => state.courses.pagintation.activePage),
  getTotalPages: createGetter((state) => state.courses.pagintation.totalPages),
  hasNextPage: createGetter((state) => state.courses.pagintation.hasNextPage),
  hasPreviousPage: createGetter((state) => state.courses.pagintation.hasPreviousPage),
